<template>
    <section class="bg pb_cover_v3 overflow-hidden   text-left  pb_slant-light" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6">
            <h2 class="heading mb-3">Sign up</h2>
            <div class="sub-heading">
              <p class="mb-4">로그인하고 나에게 맞는 영화를 추천받아요 </p>
...
button{
  ...
  font-style: normal; }
    ...
    src: url("../../assets/fonts/fontawesome/fonts/fontawesome-webfont.eot?v=4.7.0");
