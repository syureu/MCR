<template>
  <section class="w3l-header-nav mobile-header">
		...
		<div class="header-tophny editContent">
			<header id="site-header" class="hny-header-top">
				<div class="container">
                  ...
                  <a id="logo" v-if="isLoggedIn" href="/home"><img src="../../assets/logo.png" alt="Logo Image"></a></h1>
						</div>
...
.btn.focus {
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(255, 98, 26, 0.69);
}
...
@-webkit-keyframes ripple {
  0% {
    box-shadow: 0 0 0 0 rgba(255, 98, 26, 0.69), 0 0 0 10px rgba(255, 98, 26, 0.69), 0 0 0 20px rgba(255, 98, 26, 0.69);
  }

  100% {
    box-shadow: 0 0 0 10px rgba(255, 98, 26, 0.69), 0 0 0 20px rgba(255, 98, 26, 0.69), 0 0 0 40px rgba(255, 98, 26, 0.49);
  }
}
...
@keyframes ripple {
  ...
  100% {
    box-shadow: 0 0 0 10px rgba(255, 98, 26, 0.69), 0 0 0 20px rgba(255, 98, 26, 0.69), 0 0 0 40px rgba(255, 98, 26, 0.29);
  }
}
...
/*--w3l-header--*/
.w3l-header-nav .header-tophny {
  background: black;
  padding: 10px 0;
}

.w3l-header-nav .navbar-expand-lg .navbar-nav .dropdown-menu {
  transform: translateX(-50px);
}

.w3l-header-nav .dropdown-item:hover,
.w3l-header-nav .dropdown-item:focus {
  color: #F45D01;
  text-decoration: none;
  background-color: transparent;
}

.w3l-header-nav nav.navbar {
  background-color: transparent;
}

.w3l-header-nav a.navbar-brand {
  margin: 0;
  padding: 0;
  font-size: 34px;
  font-weight: 700;
...
.w3l-header-nav a.navbar-brand span {
  color: var(--secondary-color);
}

.w3l-header-nav .navbar-light .navbar-brand:hover,
.w3l-header-nav .navbar-brand:focus {
  color: var(--heading-color);
  opacity: 0.9;
}

.w3l-header-nav input#nav {
  display: none;
}

.w3l-header-nav label.nav {
  display: none;
}

.w3l-header-nav ul.nav-links li {
  display: inline-block;
  font-weight: 700;
}

.w3l-header-nav ul.nav-links li:last-child {
  margin-left: auto;
}

.w3l-header-nav .toggle-2,
.w3l-header-nav .toggle,
.w3l-header-nav [id^=drop] {
  display: none;
}
...
.w3l-header-nav .nav-mobile-block.header-align {
  display: flex;
  align-items: center;
}
...
.w3l-header-nav nav ul li.drop-list {
  position: relative;
}

.w3l-header-nav nav a {
  background: none;
  text-transform: capitalize;
...
.w3l-header-nav .angle-dropdown {
  ...
  vertical-align: .16em;
  content: "";
  border-top: 0.3em solid #141414;
  border-right: 0.2em solid transparent;
  border-bottom: 0;
  border-left: 0.2em solid transparent;
}

.w3l-header-nav .angle-dropdown-sub {
  display: inline-block;
  width: 0;
  height: 0;
  margin-left: 0.1em;
...
.w3l-header-nav nav a:hover,.w3l-header-nav nav a.active {
  background: transparent;
  color: var(--secondary-color);
  transition: all .0.3s;
}

.w3l-header-nav nav ul ul {
  display: none;
  position: absolute;
  top: 60px;
  left: 0;
...
.w3l-header-nav nav ul li:hover>ul {
  display: inherit;
}

.w3l-header-nav nav ul ul li {
  float: none;
  display: list-item;
  position: relative;
  margin: 2px 0;
...
.w3l-header-nav nav a.btn.btn-style.btn-secondary{
...
.w3l-header-nav nav a.btn.btn-style.btn-secondary:hover{

}
.w3l-header-nav nav ul ul li a:hover {
  background: transparent;
  transition: 0.3s ease;
}

.w3l-header-nav nav ul ul ul li {
  position: relative;
  top: 0;
  left: 0px;
...
/*--//--*/
.w3l-header-nav li>a:only-child:after {
  content: '';
}
...
@media all and (max-width: 992px) {
  ...
  .w3l-header-nav .nav-mobile-block {
    display: block !important;
  }

  .w3l-header-nav nav a.border-left {
  ...
  .w3l-header-nav [id^=drop]:checked+ul {
    display: block;
    width: 100%;
    background: #f5f5f5;
    border-radius: 4px;
  ...
  .w3l-header-nav nav ul ul::-webkit-scrollbar,
  .w3l-header-nav .header-4 ul.menu::-webkit-scrollbar {
    width: 4px;
  }

  .w3l-header-nav nav ul ul::-webkit-scrollbar-track,
  .w3l-header-nav .header-4 ul.menu::-webkit-scrollbar-track {
    box-shadow: inset 0 0 5px #ffffff;
    border-radius: 5px;
  }

  .w3l-header-nav nav ul ul::-webkit-scrollbar-thumb,
  .w3l-header-nav .header-4 ul.menu::-webkit-scrollbar-thumb {
  ...
  .w3l-header-nav nav a:hover,
  .w3l-header-nav nav ul ul ul a {
    background-color: transparent;
  }
  ...
  .w3l-header-nav nav ul ul li:hover>ul,
  .w3l-header-nav nav ul li:hover>ul {
    display: none;
  }
  ...
  .w3l-header-nav .navigation nav a {
    margin: 8px 0;
  }

  .w3l-header-nav label.toggle.toogle-2,
  .w3l-header-nav label.toggle.toogle-3,
  .w3l-header-nav label.toggle.toogle-4,
  .w3l-header-nav label.toggle.toogle-5,
  .w3l-header-nav label.toggle.toogle-6 {
    display: block;
    transition: none;
    font-style: normal;
    font-weight: normal;
  ...
  .w3l-header-nav label.toggle.toogle-2:hover,
  .w3l-header-nav label.toggle.toogle-3:hover,
  .w3l-header-nav label.toggle.toogle-4:hover,
  .w3l-header-nav label.toggle.toogle-5:hover,
  .w3l-header-nav label.toggle.toogle-6:hover {
    color: var(--primary-color);
  }
...
.w3l-header-nav .search-right a span.fa {
  line-height: 40px;
}
...
.w3l-main-slider .csslider>.navigation>div {
  margin-left: -100%;
}
...
.w3l-how-grids-3 .sub-wid-grid-9 span {
  font-size: 15px;
  color: #fff;
  line-height: 25px;
  background: var(--primary-color);
