    ...
    <div class="hero-container" data-aos="fade-in">
      ...
      <p>저는 <span class="typed" data-typed-items="">{{ this.actorDetail.job }}</span> 입니다</p>
        <div v-if="this.$store.getters.getUserData != null">
                                        ...
                                        data-fa-i2svg
                                        cursor="pointer"
                                        style="width:350px; height:350px; float:left; margin-right:100px;"
                                        @click="like()"
                                        >
                                        <path
                                        v-if="like_on == 1"
                                        ...
                                        <div v-if="like_on == 0" style="font-size:75px; color:red; float:left;">
                                            <br>
                                             {{ this.arrow }}
                                        </div>
                                        <div style=""></div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>{{ this.actorDetail.job }} &amp; Actor</h3>
            
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> {{ this.actorDetail.birth }}</li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Gender:</strong> {{ this.actorDetail.sex }}</li>
                </ul>
              </div>
            </div>
